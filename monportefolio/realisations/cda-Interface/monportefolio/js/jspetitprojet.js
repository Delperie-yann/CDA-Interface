document.addEventListener('DOMContentLoaded', function(){
    ...
    //modification lien des menu au click et hover
    var ulMenu = document.getElementById("ulMenu");
    ulMenu.children[2].children[0].children[1].style.backgroundColor = '#ffffff';
    ulMenu.children[2].children[0].children[0].style.display = 'block';
    ulMenu.children[2].children[0].style.cursor ='default';
