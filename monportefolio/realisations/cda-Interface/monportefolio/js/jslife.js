document.addEventListener('DOMContentLoaded', function(){
    ...
    ulMenu.children[3].children[0].children[1].style.backgroundColor = '#ffffff';
    ulMenu.children[3].children[0].children[0].style.display = 'block';
    ulMenu.children[3].children[0].style.cursor ='default';
